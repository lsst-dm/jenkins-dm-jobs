...
p.pipeline().with {
  ...
  parameters {
    ...
    stringParam('IMAGE', 'us-central1-docker.pkg.dev/rubin-shared-services-71ec/sciplat/sciplat-lab,ghcr.io/lsst-sqre/sciplat-lab', 'Fully-qualified URI(s) for Docker target image(s, comma-separated)')
