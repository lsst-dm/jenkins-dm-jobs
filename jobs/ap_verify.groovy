...
p.pipeline().with {
  ...
  parameters {
    ...
    stringParam('DOCKER_IMAGE', 'lsstsqre/centos:d_latest', 'Explicit name of release docker image including tag.')
    stringParam('ARCHITECTURE', 'docker', 'Architecture to run against.')
