...
p.pipeline().with {
  ...
  parameters {
    ...
    choiceParam('LABEL', ['centos-8-conda', 'centos-7-conda', 'osx-13', 'osx-14'], 'Jenkins build agent label')
    ...
    stringParam('PLATFORM', null, 'Published platform name (el7, 10.9, 10.13)')
  }
}
