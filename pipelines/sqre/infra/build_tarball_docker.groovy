...
notify.wrap {
  ...
  def run = {
    stage('trigger GHA') {
      ...
      def url = new URL("https://api.github.com/repos/lsst-dm/docker-tarballs/actions/workflows/build.yaml/dispatches")
    ...
    stage('poll for job completion at GHA') {
      ...
      def url = new URL("https://api.github.com/repos/lsst-dm/docker-tarballs/actions/workflows/build.yaml/runs?per_page=1&branch=${branch}")
      ...
      url = new URL("https://api.github.com/repos/lsst-dm/docker-tarballs/actions/runs/${run_id}")
