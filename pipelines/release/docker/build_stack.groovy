...
notify.wrap {
  ...
  registryTags.each { name ->
    def fixOSVersion = name.replaceFirst("7", "9")
    dev fixDistribName = fixOSVersion.replace("stack-lsst_distrib", "lsst_sitcom")
  ...
  lsstswConfigs.each{ lsstswConfig ->
    ...
    def run = {
      ...
      stage('build and push') {
        ...
        def cacheRepo = util.buildcacheRepo('scipipe-base')
        ...
        def buildArgs = [
          ...
          util.buildkitCacheArgs(cacheRepo, arch, !noPush),
